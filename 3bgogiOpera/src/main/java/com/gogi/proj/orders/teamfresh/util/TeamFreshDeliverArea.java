...
public enum TeamFreshDeliverArea {
	...
	TeamFreshDeliverArea(boolean isDeliv, List<String> areaList) {
		// TODO Auto-generated constructor stub
		this.isDeliv = isDeliv;
		this.areaList =  areaList;
	}
	
	public static TeamFreshDeliverArea findDelivPosivArea(String area) {
		
		return Arrays.stream(TeamFreshDeliverArea.values())
				.filter(teamFreshDeliverArea -> teamFreshDeliverArea.hasAreaName(area))
				.findAny()
				.orElse(POSIV);
	}
