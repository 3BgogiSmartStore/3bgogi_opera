...
public enum CjDetailDeliveryAreaCheck {
	...
	DUCYANGGU("덕양구" , Arrays.asList("원당동","신원동","성사동","북한동","효자동","오금동","용두동","벽제동","선유동","고양동","대자동","관산동","내유동","내곡동","화정동","강매동","행주내동","행주외동","신평동","행신동","현천동","덕은동","향동동","원신동","흥도동","행주동","대덕동")),
	ILSANDONGGU("일산동구", Arrays.asList("산황동","사리현동","지영동","설문동","문봉동","성석동","고봉동")),
	ILSANSUGU("일산서구", Arrays.asList("구산동","법곳동","송포동", "송산동")),
	PAJUSI("파주시", Arrays.asList("아동동","야동동","검산동","매금동","교하동","오도동","상지석동","산남동","당하동","문발동","송촌동","하지석동","서패동","신촌동","연다산동","금릉동","문산읍","파주읍","법원읍","조리읍","월롱면","탄현면","광탄면","파평면","적성면","군내면","장단면","진동면","진서면","금촌동","금촌1동","금촌2동","금촌3동","운정동","운정1동","운정2동","운정3동")),
