...
public class RoadAddress {
	...
	public RoadAddress(String address_name, String region_1depth_name, String region_2depth_name,
			String region_3depth_name, String road_name, String underground_yn, String main_building_no,
			String sub_building_no, String building_name, String zone_no, String x, String y) {
		super();
	...
	public String toString() {
		return "RoadAddress [address_name=" + address_name + ", region_1depth_name=" + region_1depth_name
				+ ", region_2depth_name=" + region_2depth_name + ", region_3depth_name=" + region_3depth_name
				+ ", road_name=" + road_name + ", underground_yn=" + underground_yn + ", main_building_no="
				+ main_building_no + ", sub_building_no=" + sub_building_no + ", building_name=" + building_name
				+ ", zone_no=" + zone_no + ", x=" + x + ", y=" + y + "]";
	}
