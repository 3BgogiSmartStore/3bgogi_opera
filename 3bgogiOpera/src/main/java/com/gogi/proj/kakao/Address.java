...
public class Address {
	...
	public Address(String address_name, String region_1depth_name, String region_2depth_name, String region_3depth_name,
			String region_3depth_h_name, String h_code, String b_code, String mountain_yn, String main_address_no,
	...
	public String toString() {
		return "Address [address_name=" + address_name + ", region_1depth_name=" + region_1depth_name
				+ ", region_2depth_name=" + region_2depth_name + ", region_3depth_name=" + region_3depth_name
				+ ", region_3depth_h_name=" + region_3depth_h_name + ", h_code=" + h_code + ", b_code=" + b_code
				+ ", mountain_yn=" + mountain_yn + ", main_address_no=" + main_address_no + ", sub_address_no="
				+ sub_address_no + ", x=" + x + ", y=" + y + "]";
	}
}
