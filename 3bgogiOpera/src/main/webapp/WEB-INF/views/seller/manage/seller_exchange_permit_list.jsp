                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title"> 환전 완료 목록 </h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page"> 환전 완료 목록 </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-8 col-md-8 col-sm-12 col-12">
	                        <div class="card">
                                <h5 class="card-header"> 환전 완료 목록 </h5>
                                <div class="card-body">
                                	<div class="table-responsive">
	                                    <table id="example2" class="table table-bordered" style="text-align:center; font-size: 12px; word-break: keep-all; white-space: nowrap;">
	                                        ...
	                                        <tbody>
	                                        	<c:if test="${empty permitList }">
	                                        		<tr>
	                                        			<td colspan="4"> 환전 완료 내역이 존재하지 않습니다. </td>
	                                        		</tr>
	                                        	</c:if>
	                                        	<c:if test="${!empty permitList }">	                                        	
		                                        	<c:forEach var="permitlist" items="${permitList }">                                        	
			                                            <tr class="table-3bgogi-hover">
			                                                <td>${permitlist.adminName }</td>
			                                                <td>${permitlist.adminPhone }</td>
															<td>
																<fmt:formatNumber value="${permitlist.sellerExchangeVO.seExchangePrice }" pattern="#,###"/> 원
															</td>
															
															<td>
																${permitlist.sellerExchangeVO.sePermitDate }
															</td>
			                                            </tr>
						...
						<div class="col-xl-3 col-lg-4 col-md-4 col-sm-12 col-12">
                        	<form id="permitListSearchForm" action="<c:url value='/seller/manage/seller_exchange_permit_list.do'/>" method="get">
