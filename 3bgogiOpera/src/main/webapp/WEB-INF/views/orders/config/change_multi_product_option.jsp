...
<body>
	<div class="container-fluid  dashboard-content">
		<form id="changeMultiProductAndOptionForm" style="display: none;">
		
		</form>
		<form class="row" name="changeProductOptionListSearchForm" action="<c:url value='/order/config/multi_change_product_option.do'/>" method="get">
			<c:forEach var="orPkList" items="${orPks }">
				<input class="orPkList" type="hidden" value="${orPkList }" name="orPks">
			</c:forEach>
...
<script src="${pageContext.request.contextPath}/resources/libs/js/renewal_multi_prod_change.js"></script>
</html>
