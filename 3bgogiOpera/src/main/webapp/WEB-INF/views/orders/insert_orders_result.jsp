						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="javascript:void(0);"
									class="breadcrumb-link"> 주문서 </a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0);"
									class="breadcrumb-link"> 주문 입력 </a></li>
								<li class="breadcrumb-item"><a href="javascript:void(0);"
									class="breadcrumb-link"> 주문 등록 </a></li>
		...
		<div class="row">
								...
								<tbody>
									<c:forEach var="epostList" items="${epostResultList }">
										<c:if test="${empty epostList.error_code }">
											<tr>
												<td>${epostList.orVO.orBuyerName } /
													${epostList.orVO.orReceiverName }</td>
												<td>${epostList.orVO.orBuyerContractNumber1 }</td>
												<td>${epostList.orVO.orShippingAddress }
													${epostList.orVO.orShippingAddressDetail }</td>
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<a class="btn btn-primary btn-xs"
					href="<c:url value='/orders/order_page.do'/>"> 확인 </a>
			</div>
		</div>
	</div>
	<!-- /page content -->
